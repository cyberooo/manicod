...
# The distribution of labels is COVID-Sci test set is
# 'true': 41, 
# 'false': 101, 
...
with open("covid-scientific-raw.json") as f:
    all_contents = json.load(f)
    raw_claims = all_contents['examples']
    print("[INFO] " + str(len(raw_claims)) + " claims found in COVID-scientific data set.")
    for d in raw_claims:
